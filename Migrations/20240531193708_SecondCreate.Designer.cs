...
namespace PoPProject.Migrations
{
    ...
    [Migration("20240531193708_SecondCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TEAM_ONE_AND_ZERO_BACKEND.Models.Song", b =>
                {
                    b.Property<int>("SongId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TEAM_ONE_AND_ZERO_BACKEND.Models.Comment", b =>
                {
                    b.HasOne("TEAM_ONE_AND_ZERO_BACKEND.Models.Song", "Song")
                        .WithMany("Comments")
                        .HasForeignKey("SongId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TEAM_ONE_AND_ZERO_BACKEND.Models.User", "User")
                        .WithMany("Comments")
